...
set Vendor      "esl"
set Library     "hls"
set IPName      "Buffer_ADC"
set Version     "1.0"
set DisplayName "Virtual_ADC"
set Revision    "2113328457"
...
set xo_kernel_name "Buffer_ADC"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/rrodrigu/x-heep-femu/imp/hls/hls_projects/Virtual_ADC/baseline"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/rrodrigu/x-heep-femu/imp/hls/hls_projects/Virtual_ADC/baseline/.debug"
set xo_hls_files_dir ""
set hdl_module_list {Buffer_ADC_gmem_m_axi
Buffer_ADC_control_s_axi
Buffer_ADC
}
set kernel_xo ""
set detect_deadlock_json "Buffer_ADC_message_dict.json"

## Variables
set Top "Buffer_ADC"
set TopNoPrefix "Buffer_ADC"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 DDR_size W 0x0 "Data signal of DDR_size" {{0 32 DDR_size W 0 "Bit 31 to 0 of DDR_size"}}} {0x18 DDR_cons_addr R 0x0 "Data signal of DDR_cons_addr" {{0 32 DDR_cons_addr R 0 "Bit 31 to 0 of DDR_cons_addr"}}} {0x1c DDR_cons_addr_ctrl R 0x0 "Control signal of DDR_cons_addr" {{0 1 DDR_cons_addr_ap_vld R 0 "Control signal DDR_cons_addr_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 DDR_prod_addr W 0x0 "Data signal of DDR_prod_addr" {{0 32 DDR_prod_addr W 0 "Bit 31 to 0 of DDR_prod_addr"}}} {0x30 DDR_Ready W 0x0 "Data signal of DDR_Ready" {{0 32 DDR_Ready W 0 "Bit 31 to 0 of DDR_Ready"}}} {0x38 DDR_Master_1 W 0x0 "Data signal of DDR_Master" {{0 32 DDR_Master W 0 "Bit 31 to 0 of DDR_Master"}}} {0x3c DDR_Master_2 W 0x0 "Data signal of DDR_Master" {{0 32 DDR_Master W 0 "Bit 63 to 32 of DDR_Master"}}} {0x44 ADC_buffer_error_i W 0x0 "Data signal of ADC_buffer_error_i" {{0 1 ADC_buffer_error_i W 0 "Bit 0 to 0 of ADC_buffer_error_i"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x4c ADC_buffer_error_o R 0x0 "Data signal of ADC_buffer_error_o" {{0 1 ADC_buffer_error_o R 0 "Bit 0 to 0 of ADC_buffer_error_o"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 ADC_buffer_error_o_ctrl R 0x0 "Control signal of ADC_buffer_error_o" {{0 1 ADC_buffer_error_o_ap_vld R 0 "Control signal ADC_buffer_error_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
source -notrace "/home/rrodrigu/Xilinx/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
