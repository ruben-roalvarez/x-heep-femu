...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("ADC_mem_address1", 11, hls_out, 6, "ap_memory", "MemPortADDR2", 1),
	Port_Property("ADC_mem_ce1", 1, hls_out, 6, "ap_memory", "MemPortCE2", 1),
	Port_Property("ADC_mem_we1", 1, hls_out, 6, "ap_memory", "MemPortWE2", 1),
	Port_Property("ADC_mem_d1", 32, hls_out, 6, "ap_memory", "MemPortDIN2", 1),
	Port_Property("ADC_Ready", 1, hls_in, 7, "ap_none", "in_data", 1),
	Port_Property("ADC_buffer_cons_addr", 10, hls_in, 8, "ap_none", "in_data", 1),
	Port_Property("ADC_buffer_prod_addr", 10, hls_out, 9, "ap_none", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "Buffer_ADC";
